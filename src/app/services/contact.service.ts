...
export class ContactService {
  ...
  public loadContacts(): void {
    if (!this.storageService.load('contacts').length) {
      this.storageService.store('contacts', this._contactsDb);
    }
    let contacts = JSON.parse(this.storageService.load('contacts'));
